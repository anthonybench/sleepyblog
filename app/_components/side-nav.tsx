        ...
        >
              ...
              {links.map((link) => {
                ...
                return (
                  <Link
                    ...
                    //   },
                    // )}
                    className={`flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium md:flex-none md:justify-start md:p-2 md:px-3 ${pathname === link.href ? "bg-sky-100 text-blue-600" : selectedTheme.pkg.navLink}`}
                  >
          ...
          <footer className={`w-full px-5 ${selectedTheme.txt.muted}`}>
            ...
            <div className="flex h-5 items-center justify-center space-x-4 py-10 text-sm">
              <Link
                href="https://github.com/anthonybench/sleepyblog/blob/main/README.md"
                target="_blank"
              >
                <GithubLogo />
              </Link>
